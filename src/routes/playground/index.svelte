<script>
  ...
  {#if user_name}
    <div class="user-welcome text-3xl text-gray-700 font-nunito font-medium tracking-wide" >{$user_name} PLAYGR<img src={black_logo} alt="Svelvet logo in black"/>UND</div>
  {:else}
  <div class="user-welcome text-3xl text-gray-700 font-nunito font-medium tracking-wide" >{$user_name}PLAYGR<img src={black_logo} alt="Svelvet logo in black"/>UND</div>
  {/if}
