<script>
  ...
  const initialEdges = [
    ...
    { id: 'e14-16', source: 14, target: 16, type: 'straight' },
    { id: 'e10-13', source: 10, target: 13, type: 'straight' },
  ];
</script>
