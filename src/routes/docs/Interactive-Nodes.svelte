<h2 class="text-4xl font-semibold mb-12">Interactive Node Linking & Creation</h2>
...
<div>
  <h3 class="text-xl font-semibold mt-12 mb-6">Implementing Node Linking & Creation</h3>
  <p class="text-gray-600">
