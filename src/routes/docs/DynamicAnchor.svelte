...
<div>
<h2 class="text-4xl font-semibold mb-12">Dynamic Anchor</h2>
</div>

<p class="text-gray-600">
  <code class="code">Svelvet</code> now have <code class="code">dynamic anchors</code> as a new feature! Drag the nodes around and see what happens to the anchors!
</p>
...
<iframe src="https://codesandbox.io/embed/feature-dynamic-anchors-fwmgmu?fontsize=14&hidenavigation=1&theme=dark"
