...
<div class="topic-container">
    ...
    <div class="body">
            ...
            <div class="metrics">
                <div class="upvote">
                    ...
                    <div style="display: flex; align-items: center;">
                      ...
                      <pre class="status">STARS: {toggleClicked}</pre>
        ...
        <div class="content">
         <b><h2>Reasons Why I Love Team Svelvet!</h2> </b>
            <br>Body Starts HERE. I love Svelvet 3.0 and the team did an amazing job. Some features that I really like includes....the community page and how I can search between templates and different discussions. Additionally I really like how functionaly the new playground update is! 
        </div>
    </div>
</div>
...
.reply-box input:hover{
    border: solid 1px #000000;
}

.head{
    display: flex;
    background-color: #ff4561b2;
    padding: 5px;
    font-weight: bold;
    font-size: 14px;
    padding-left: 8px;
