  ...
  const initialNodes = [
    {
      ...
      position: { x: 100, y: 20 },
      data: {
        html: ` <video width="480" height="360" src="https://i.imgur.com/zdT6tSz.mp4" controls autoplay loop></video>`,
      },
      width: 100,
      height: 100,
      bgColor: 'white',
...
<h1>Edit Edges</h1>
Hover over an edge, then write click to bring up the "Edit Edge" modal. This feature
