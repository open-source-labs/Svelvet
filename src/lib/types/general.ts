...
export type NodeTypes = { [key: string]: any }; // ComponentType<NodeProps>
export type NodeTypesWrapped = { [key: string]: any }; // MemoExoticComponent<ComponentType<WrapNodeProps>>
export type EdgeTypes = { [key: string]: any }; // ComponentType<EdgeProps>
export type EdgeTypesWrapped = { [key: string]: any }; // MemoExoticComponent<ComponentType<WrapEdgeProps>>
...
export type OnConnectStart = (event: any, params: OnConnectStartParams) => void; // ReactMouseEvent
...
export type ReactFlowStore = {
	...
	d3Zoom: any | null; // ZoomBehavior<Element, unknown>
	d3Selection: any | null; // D3Selection<Element, unknown, null, undefined>
	...
	defaultEdgeOptions?: any; // DefaultEdgeOptions
