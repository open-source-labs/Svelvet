<script lang='ts'>
    ...
    <!-- <path d="M10 10 C 40 10, 65 10, 95 80 S 150 150, 180 80" stroke="black"/> -->
    <!-- creates line -->
    <path d={`M ${reactEdge.sourceX.toString()} ${reactEdge.sourceY.toString()} L ${reactEdge.targetX.toString()} ${reactEdge.targetY.toString()}`}  stroke="black"/>
