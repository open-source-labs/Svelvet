  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      {#if $advancedNodeToggle === true}
        ...
        <input id="edgeColor" bind:value={$edgeColor} type="color" /> <br />
        <label for="labelBgColor">Label Bg Color:</label>
        <input id="labelBgColor" bind:value={$labelBgColor} type="color" /> <br />
        <label for="labelTextColor">Label Text Color:</label>
        <input id="labelTextColor" bind:value={$labelTextColor} type="color" /> <br />
        <label for="edgeColor">Edge Color:</label>
        <input id="edgeColor" bind:value={$edgeColor} type="color" /> <br />
        <label for="noHandle">Handle:</label>
        <input id="noHandle" bind:value={$noHandle} placeholder="yes or no" type="text" /> <br />
        <hr />
      {/if}
    </div>
    <footer>
      {#if $advancedNodeToggle === false}
        <button
          ...
          id="btn"
          on:click={() => {
            !$advancedNodeToggle ? ($advancedNodeToggle = true) : ($advancedNodeToggle = false);
