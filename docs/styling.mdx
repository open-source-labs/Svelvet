...
These theme names cna be passed to the [Svelvet](components/svelvet) component via the reactive `theme` prop and to the [Theme Toggle](components/theme-toggle) component via the `main` and `alt` props.
