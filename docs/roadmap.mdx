...
### Drag and Drop Drawer Component

A [Drawer](../components/drawer) component has been released in version `8.0.0`. Updates to address the ability to take custom Nodes as props, edit nodes that already exist on the graph, and exporting of the graph coming soon in a future update.
