...
- feat: added a new drag-and-drop [Drawer](../components/drawer) component that can take custome Nodes, Anchors and Edges as props and add them to the canvas via the UI
- feat: added a new input component [Knob](../data-flow/knob) component to the collection of already existing
  data flow system components that can be composed in custom nodes and customized by users
- docs: updated documentation to include an Example section that features a usecase of Svelvet as a [Database Management](../examples/database) tool
- docs: updated the documentation page to on website to include newest version release
...
- chore: updated packge version
- Additional functionality and control to Drawer component coming soon!
