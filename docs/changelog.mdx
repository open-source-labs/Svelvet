...
- feat: added a new drag-and-drop [Drawer](../components/drawer) component that can take custom Nodes, Anchors and Edges as props and add them to the canvas via the UI
