...
var app = (function () {
  ...
  `);
    			...
    			add_location(div, file$6, 184, 0, 6568);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    class GreyNode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$6, create_fragment$6, safe_not_equal, { key: 0, node: 1 });
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$nodesStore*/ 8) greynode_changes.node = /*node*/ ctx[16];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(96:8) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "" + (null_to_empty(`miniMap`) + " svelte-978ti0"));
    			set_style(div, "height", /*mapHeight*/ ctx[2] + "px");
    			set_style(div, "width", /*mapWidth*/ ctx[1] + "px");
    			add_location(div, file$5, 94, 4, 3484);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console_1$1.warn("<Minimap> was created without expected prop 'key'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Minimap> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('key' in $$props) $$invalidate(0, key = $$props.key);
    		if ('firstGo' in $$props) $$invalidate(5, firstGo = $$props.firstGo);
    		if ('mapWidth' in $$props) $$invalidate(1, mapWidth = $$props.mapWidth);
    		if ('mapHeight' in $$props) $$invalidate(2, mapHeight = $$props.mapHeight);
    		if ('nodeHeight' in $$props) $$invalidate(6, nodeHeight = $$props.nodeHeight);
    		if ('nodeWidth' in $$props) $$invalidate(7, nodeWidth = $$props.nodeWidth);
    		if ('heightRatio' in $$props) $$invalidate(8, heightRatio = $$props.heightRatio);
    		if ('widthRatio' in $$props) $$invalidate(9, widthRatio = $$props.widthRatio);
    		if ('midpoint' in $$props) midpoint = $$props.midpoint;
    		if ('nodeXleftPosition' in $$props) $$invalidate(10, nodeXleftPosition = $$props.nodeXleftPosition);
    		if ('nodeYtopPosition' in $$props) $$invalidate(11, nodeYtopPosition = $$props.nodeYtopPosition);
    		if ('nodeYbottomPosition' in $$props) $$invalidate(12, nodeYbottomPosition = $$props.nodeYbottomPosition);
    		if ('nodeXrightPosition' in $$props) $$invalidate(13, nodeXrightPosition = $$props.nodeXrightPosition);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*firstGo, $nodesStore, nodeXleftPosition, nodeXrightPosition, nodeYbottomPosition, nodeYtopPosition, nodeWidth, nodeHeight, mapHeight, mapWidth, heightRatio, widthRatio*/ 16366) {
    			// reactive object that updates every time nodesStore is updated
    			{
    				if (firstGo) {
    					//sets initial position values for furthest nodes
    					$nodesStore.forEach(node => {
    						$$invalidate(10, nodeXleftPosition = Math.min(nodeXleftPosition, node.position.x));
    						$$invalidate(13, nodeXrightPosition = Math.max(nodeXrightPosition, node.position.x));
    						$$invalidate(12, nodeYbottomPosition = Math.min(nodeYbottomPosition, node.position.y));
    						$$invalidate(11, nodeYtopPosition = Math.max(nodeYtopPosition, node.position.y));
    					});

    					// set height and width
    					$$invalidate(6, nodeHeight = nodeYtopPosition - nodeYbottomPosition);

    					$$invalidate(7, nodeWidth = nodeXrightPosition - nodeXleftPosition);

    					// reassign midpoint
    					midpoint = { x: nodeWidth / 2, y: nodeHeight / 2 };

    					//ends the first round
    					$$invalidate(5, firstGo = !firstGo);
    				} else {
    					//reassign node positions for reassignment within updated store
    					$$invalidate(10, nodeXleftPosition = Infinity);

    					$$invalidate(11, nodeYtopPosition = -Infinity);
    					$$invalidate(12, nodeYbottomPosition = Infinity);
    					$$invalidate(13, nodeXrightPosition = -Infinity);
    					...
    					$$invalidate(6, nodeHeight = Math.abs(nodeYbottomPosition - nodeYtopPosition));

    					$$invalidate(7, nodeWidth = Math.abs(nodeXleftPosition - nodeXrightPosition));
    					midpoint = { x: nodeWidth / 2, y: nodeHeight / 2 };
    				}
    				...
    				$$invalidate(8, heightRatio = (mapHeight / nodeHeight).toFixed(2));
    				$$invalidate(9, widthRatio = (mapWidth / nodeWidth).toFixed(2));
