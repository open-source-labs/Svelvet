...
var app = (function () {
  ...
  `)) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label0, "class", "svelte-xp9o0j");
    			add_location(label0, file$a, 76, 4, 2311);
    			...
    			attr_dev(input0, "class", "svelte-xp9o0j");
    			add_location(input0, file$a, 77, 4, 2354);
    			attr_dev(label1, "for", "width-input");
    			attr_dev(label1, "class", "svelte-xp9o0j");
    			add_location(label1, file$a, 78, 4, 2491);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "width-input");
    			attr_dev(input1, "placeholder", input1_placeholder_value = /*currentNode*/ ctx[4].width);
    			attr_dev(input1, "class", "svelte-xp9o0j");
    			add_location(input1, file$a, 79, 4, 2534);
    			attr_dev(label2, "for", "height-input");
    			attr_dev(label2, "class", "svelte-xp9o0j");
    			add_location(label2, file$a, 80, 4, 2630);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "id", "height-input");
    			attr_dev(input2, "placeholder", input2_placeholder_value = /*currentNode*/ ctx[4].height);
    			attr_dev(input2, "class", "svelte-xp9o0j");
    			add_location(input2, file$a, 81, 4, 2675);
    			attr_dev(label3, "for", "bg-color-input");
    			attr_dev(label3, "class", "svelte-xp9o0j");
    			add_location(label3, file$a, 82, 4, 2774);
    			attr_dev(input3, "type", "color");
    			attr_dev(input3, "id", "bg-color-input");
    			attr_dev(input3, "class", "svelte-xp9o0j");
    			add_location(input3, file$a, 83, 4, 2831);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "placeholder", input4_placeholder_value = /*currentNode*/ ctx[4].bgColor);
    			attr_dev(input4, "class", "svelte-xp9o0j");
    			add_location(input4, file$a, 84, 4, 2906);
    			attr_dev(label4, "for", "custom-class-input");
    			attr_dev(label4, "class", "svelte-xp9o0j");
    			add_location(label4, file$a, 85, 4, 2966);
    			...
    			attr_dev(input5, "class", "svelte-xp9o0j");
    			add_location(input5, file$a, 86, 4, 3023);
    			attr_dev(form, "class", "svelte-xp9o0j");
    			add_location(form, file$a, 75, 2, 2279);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$a, 73, 2, 2232);
    			attr_dev(button, "class", "svelte-xp9o0j");
    			add_location(button, file$a, 89, 2, 3183);
    			attr_dev(div, "class", "edit-modal svelte-xp9o0j");
    			add_location(div, file$a, 72, 0, 2205);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	let currentNode;
    	let test = 'test';
    	const { nodesStore, nodeIdSelected, getStyles } = findOrCreateStore(key);
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 187, 4, 5789);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$7, 184, 6, 5733);
    			add_location(div, file$7, 183, 4, 5721);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$7, 175, 6, 5520);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 124, 0, 4295);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
