...
>>>>>>> testenv
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console.warn("<GreyNode> was created without expected prop 'key'");
    		}

    		if (node === undefined && !('node' in $$props || $$self.$$.bound[$$self.$$.props['node']])) {
    			console.warn("<GreyNode> was created without expected prop 'node'");
    		}

    		if (heightRatio === undefined && !('heightRatio' in $$props || $$self.$$.bound[$$self.$$.props['heightRatio']])) {
    			console.warn("<GreyNode> was created without expected prop 'heightRatio'");
    		}

    		if (widthRatio === undefined && !('widthRatio' in $$props || $$self.$$.bound[$$self.$$.props['widthRatio']])) {
    			console.warn("<GreyNode> was created without expected prop 'widthRatio'");
    		}

    		if (nodeXleftPosition === undefined && !('nodeXleftPosition' in $$props || $$self.$$.bound[$$self.$$.props['nodeXleftPosition']])) {
    			console.warn("<GreyNode> was created without expected prop 'nodeXleftPosition'");
    		}

    		if (nodeYbottomPosition === undefined && !('nodeYbottomPosition' in $$props || $$self.$$.bound[$$self.$$.props['nodeYbottomPosition']])) {
    			console.warn("<GreyNode> was created without expected prop 'nodeYbottomPosition'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<GreyNode> was created with unknown prop '${key}'`);
    	});
    ...
    class GreyNode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get key() {
    		throw new Error("<GreyNode>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set key(value) {
    		throw new Error("<GreyNode>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
...
>>>>>>> testenv
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console.warn("<Minimap> was created without expected prop 'key'");
    		}

    		if (d3Translate === undefined && !('d3Translate' in $$props || $$self.$$.bound[$$self.$$.props['d3Translate']])) {
    			console.warn("<Minimap> was created without expected prop 'd3Translate'");
    		}
    	});
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*node*/ ctx[0].src)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 62, 2, 1753);
    			...
    			attr_dev(div, "id", div_id_value = "svelvet-" + /*node*/ ctx[0].id);
    			add_location(div, file$4, 21, 0, 785);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ImageNode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$4, create_fragment$4, safe_not_equal, { node: 0, key: 1 });
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			create_component(minimap_1.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(minimap_1, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(minimap_1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(minimap_1.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(minimap_1, detaching);
    		}
    	};
...
>>>>>>> testenv
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function zoomInit() {
    		...
    		$$invalidate(4, d3Translate = d3.zoomIdentity.translate(initialLocation.x, initialLocation.y).scale(Number.parseFloat(.4 + .16 * initialZoom).toFixed(2)));
    		console.log(d3Translate);
