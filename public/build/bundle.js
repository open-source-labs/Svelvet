    ...
    */
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (role === undefined && !('role' in $$props || $$self.$$.bound[$$self.$$.props['role']])) {
    			console_1$1.warn("<EdgeAnchor> was created without expected prop 'role'");
    		}
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "nodes svelte-14qfyer");
    			...
    			add_location(div, file$6, 33, 0, 1087);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		if ($$self.$$.dirty & /*node, heightRatio, widthRatio, nodeYbottomPosition, nodeXleftPosition*/ 992) {
    			{
    				...
    				$$invalidate(0, top = Math.max(Math.abs(nodeYbottomPosition * heightRatio) + node.position.y * heightRatio + 5, 1));
    				$$invalidate(1, left = Math.max(Math.abs(nodeXleftPosition * widthRatio) + node.position.x * widthRatio + 5, 1));
    			}
    		}
    	};
    ...
    function create_each_block$1(ctx) {
    	...
    	greynode = new GreyNode({
    			props: {
    				node: /*node*/ ctx[19],
    				key: /*key*/ ctx[0],
    				heightRatio: /*heightRatio*/ ctx[6],
    				widthRatio: /*widthRatio*/ ctx[7],
    				nodeXleftPosition: /*nodeXleftPosition*/ ctx[3],
    				nodeYbottomPosition: /*nodeYbottomPosition*/ ctx[4]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$nodesStore*/ 32) greynode_changes.node = /*node*/ ctx[19];
    			if (dirty & /*key*/ 1) greynode_changes.key = /*key*/ ctx[0];
    			if (dirty & /*heightRatio*/ 64) greynode_changes.heightRatio = /*heightRatio*/ ctx[6];
    			if (dirty & /*widthRatio*/ 128) greynode_changes.widthRatio = /*widthRatio*/ ctx[7];
    			if (dirty & /*nodeXleftPosition*/ 8) greynode_changes.nodeXleftPosition = /*nodeXleftPosition*/ ctx[3];
    			if (dirty & /*nodeYbottomPosition*/ 16) greynode_changes.nodeYbottomPosition = /*nodeYbottomPosition*/ ctx[4];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(118:8) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	let current;
    	let each_value = /*$nodesStore*/ ctx[5];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "viewBox");
    			set_style(div0, "height", 10 + "px");
    			set_style(div0, "width", 10 + "px");
    			add_location(div0, file$5, 116, 8, 4311);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(`miniMap miniMap-${/*key*/ ctx[0]}`) + " svelte-ilib2s"));
    			set_style(div1, "height", /*mapHeight*/ ctx[2] + "px");
    			set_style(div1, "width", /*mapWidth*/ ctx[1] + "px");
    			add_location(div1, file$5, 115, 4, 4215);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*key*/ 1 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`miniMap miniMap-${/*key*/ ctx[0]}`) + " svelte-ilib2s"))) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { key } = $$props;
    	let { d3Scale } = $$props;
    	let { yd3Translate } = $$props;
    	let { xd3Translate } = $$props;
    	const svelvetStore = findOrCreateStore(key);
    	const { nodesStore } = svelvetStore;
    	validate_store(nodesStore, 'nodesStore');
    	component_subscribe($$self, nodesStore, value => $$invalidate(5, $nodesStore = value));
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (d3Scale === undefined && !('d3Scale' in $$props || $$self.$$.bound[$$self.$$.props['d3Scale']])) {
    			console.warn("<Minimap> was created without expected prop 'd3Scale'");
    		}

    		if (yd3Translate === undefined && !('yd3Translate' in $$props || $$self.$$.bound[$$self.$$.props['yd3Translate']])) {
    			console.warn("<Minimap> was created without expected prop 'yd3Translate'");
    		}

    		if (xd3Translate === undefined && !('xd3Translate' in $$props || $$self.$$.bound[$$self.$$.props['xd3Translate']])) {
    			console.warn("<Minimap> was created without expected prop 'xd3Translate'");
    		}
    	});

    	const writable_props = ['key', 'd3Scale', 'yd3Translate', 'xd3Translate'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('d3Scale' in $$props) $$invalidate(9, d3Scale = $$props.d3Scale);
    		if ('yd3Translate' in $$props) $$invalidate(10, yd3Translate = $$props.yd3Translate);
    		if ('xd3Translate' in $$props) $$invalidate(11, xd3Translate = $$props.xd3Translate);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('yd3Translate' in $$props) $$invalidate(10, yd3Translate = $$props.yd3Translate);
    		if ('xd3Translate' in $$props) $$invalidate(11, xd3Translate = $$props.xd3Translate);
    		if ('firstGo' in $$props) firstGo = $$props.firstGo;
    		...
    		if ('nodeHeight' in $$props) $$invalidate(12, nodeHeight = $$props.nodeHeight);
    		if ('nodeWidth' in $$props) $$invalidate(13, nodeWidth = $$props.nodeWidth);
    		if ('heightRatio' in $$props) $$invalidate(6, heightRatio = $$props.heightRatio);
    		if ('widthRatio' in $$props) $$invalidate(7, widthRatio = $$props.widthRatio);
    		if ('nodeXleftPosition' in $$props) $$invalidate(3, nodeXleftPosition = $$props.nodeXleftPosition);
    		if ('nodeYtopPosition' in $$props) $$invalidate(14, nodeYtopPosition = $$props.nodeYtopPosition);
    		if ('nodeYbottomPosition' in $$props) $$invalidate(4, nodeYbottomPosition = $$props.nodeYbottomPosition);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$nodesStore, nodeXleftPosition, nodeXrightPosition, nodeYbottomPosition, nodeYtopPosition, nodeHeight, nodeWidth, mapHeight, mapWidth*/ 61502) {
    			{
    				$$invalidate(3, nodeXleftPosition = Infinity);
    				$$invalidate(14, nodeYtopPosition = -Infinity);
    				$$invalidate(4, nodeYbottomPosition = Infinity);
    				$$invalidate(15, nodeXrightPosition = -Infinity);

    				$nodesStore.forEach(node => {
    					$$invalidate(3, nodeXleftPosition = Math.min(nodeXleftPosition, node.position.x));
    					$$invalidate(15, nodeXrightPosition = Math.max(nodeXrightPosition, node.position.x));
    					$$invalidate(4, nodeYbottomPosition = Math.min(nodeYbottomPosition, node.position.y));
    					$$invalidate(14, nodeYtopPosition = Math.max(nodeYtopPosition, node.position.y));
    				});

    				// sets the height, width of nodes after movement
    				$$invalidate(12, nodeHeight = Math.abs(nodeYbottomPosition - nodeYtopPosition));

    				$$invalidate(13, nodeWidth = Math.abs(nodeXleftPosition - nodeXrightPosition));
    				$$invalidate(12, nodeHeight = nodeYtopPosition - nodeYbottomPosition);
    				$$invalidate(13, nodeWidth = nodeXrightPosition - nodeXleftPosition);
    				...
    				$$invalidate(6, heightRatio = ((mapHeight - 25) / nodeHeight).toFixed(2));
    				$$invalidate(7, widthRatio = ((mapWidth - 25) / nodeWidth).toFixed(2));
    			}
    		}
    	};
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 88, 6, 2477);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 51, 0, 1544);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*moving, $movementStore*/ 131076) {
    ...
    // (115:6) {#if node.image && !node.data.label}
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$nodesStore*/ 64) imagenode_changes.node = /*node*/ ctx[31];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(115:6) {#if node.image && !node.data.label}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*node*/ ctx[31].image && !/*node*/ ctx[31].data.label) return 0;
    		if (/*node*/ ctx[31].data.html) return 1;
    		return 2;
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(114:4) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$2, 149, 4, 5696);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(149:2) {#if $backgroundStore}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(156:6) {#if edge.type === 'straight'}",
    		ctx
    	});
    ...
    // (155:4) {#each $derivedEdges as edge}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(155:4) {#each $derivedEdges as edge}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	minimap = new Minimap({
    			props: {
    				key: /*key*/ ctx[2],
    				d3Scale: /*d3Scale*/ ctx[15],
    				xd3Translate: /*xd3Translate*/ ctx[3],
    				yd3Translate: /*yd3Translate*/ ctx[4]
    			},
    			$$inline: true
    		});
    	...
    	let if_block = /*$backgroundStore*/ ctx[5] && create_if_block_3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$2, 138, 6, 5484);
    			...
    			add_location(pattern, file$2, 130, 4, 5325);
    			add_location(defs, file$2, 129, 2, 5314);
    			add_location(g, file$2, 153, 2, 5873);
    			attr_dev(svg, "class", svg_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-n8qkrl"));
    			attr_dev(svg, "viewBox", svg_viewBox_value = "0 0 " + /*$widthStore*/ ctx[7] + " " + /*$heightStore*/ ctx[8]);
    			add_location(svg, file$2, 128, 0, 5233);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*xd3Translate*/ 8) minimap_changes.xd3Translate = /*xd3Translate*/ ctx[3];
    			if (dirty[0] & /*yd3Translate*/ 16) minimap_changes.yd3Translate = /*yd3Translate*/ ctx[4];
    			...
    			if (dirty[0] & /*$derivedEdges*/ 512) {
    				each_value = /*$derivedEdges*/ ctx[9];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (!current || dirty[0] & /*$widthStore, $heightStore*/ 384 && svg_viewBox_value !== (svg_viewBox_value = "0 0 " + /*$widthStore*/ ctx[7] + " " + /*$heightStore*/ ctx[8])) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	validate_store(nodeSelected, 'nodeSelected');
    	component_subscribe($$self, nodeSelected, value => $$invalidate(20, $nodeSelected = value));
    	...
    	function handleZoom(e) {
    		...
    		$$invalidate(3, xd3Translate = e.transform.x);
    		$$invalidate(4, yd3Translate = e.transform.y);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('initialZoom' in $$props) $$invalidate(16, initialZoom = $$props.initialZoom);
    		if ('initialLocation' in $$props) $$invalidate(17, initialLocation = $$props.initialLocation);
    		if ('xd3Translate' in $$props) $$invalidate(3, xd3Translate = $$props.xd3Translate);
    		if ('yd3Translate' in $$props) $$invalidate(4, yd3Translate = $$props.yd3Translate);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 128, 1, 2723);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 129, 14, 2760);
    			add_location(p, file, 129, 1, 2747);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 127, 0, 2715);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
