...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    ...
    height:${/*anchorHeight*/ ctx[14]}px;
    width:${/*anchorWidth*/ ctx[13]}px;
    top: ${/*top*/ ctx[5]}px;
    left:${/*left*/ ctx[6]}px;
  `);
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "mouseup", /*mouseup_handler_1*/ ctx[26], false, false, false),
  ...
  `)) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	let top;
    	let left;
    	const { onEdgeMove, onTouchMove, setAnchorPosition, setNewEdgeProps, renderEdge, renderNewNode, hoveredElement, derivedEdges, nodesStore } = findOrCreateStore(key);
    	...
    	const mouseleave_handler = e => {
    		if (edgeShouldMove) $$invalidate(3, newEdge = renderEdge(e, node, role, position)); // renders the new edge on the screen
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('anchorWidth' in $$props) $$invalidate(13, anchorWidth = $$props.anchorWidth);
    		if ('anchorHeight' in $$props) $$invalidate(14, anchorHeight = $$props.anchorHeight);
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			add_location(div, file$5, 184, 4, 5909);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", div_class_value = "Node " + (/*node*/ ctx[0].className || '') + " svelte-fsfw70");
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*node*/ 1 && div_class_value !== (div_class_value = "Node " + (/*node*/ ctx[0].className || '') + " svelte-fsfw70")) {
    				attr_dev(div, "class", div_class_value);
    			}
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    ...
    function create_if_block_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(128:6) {#if node.data.html}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(123:4) {#each $nodesStore as node}",
    		ctx
    	});
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(162:2) {#if $backgroundStore}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(169:6) {#if edge.type === 'straight'}",
    		ctx
    	});
    ...
    // (168:4) {#each $derivedEdges as edge}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(168:4) {#each $derivedEdges as edge}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let if_block1 = /*$backgroundStore*/ ctx[6] && create_if_block_3(ctx);
...
>>>>>>> b0a590d78afd7bb6e9781674c15e4f0dcdb6de9c
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*$widthStore, $heightStore*/ 288 && svg_viewBox_value !== (svg_viewBox_value = "0 0 " + /*$widthStore*/ ctx[5] + " " + /*$heightStore*/ ctx[8])) {
