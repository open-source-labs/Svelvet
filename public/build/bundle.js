...
=======
    			add_location(rect, file$8, 26, 4, 779);
>>>>>>> testenv
...
=======
    			add_location(text_1, file$8, 35, 4, 1016);
    			add_location(g, file$8, 25, 2, 771);
>>>>>>> testenv
    		},
...
=======
    		init$1(this, options, instance$c, create_fragment$c, safe_not_equal, { edgeTextProps: 6 });
>>>>>>> testenv
...
=======
    			add_location(path_1, file$7, 41, 2, 891);
>>>>>>> testenv
    		},
    		m: function mount(target, anchor) {
...
=======
    			add_location(path_1, file$7, 32, 2, 698);
>>>>>>> testenv
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, path_1, anchor);
...
=======
    			add_location(polygon, file$7, 27, 4, 617);
>>>>>>> testenv
...
=======
    			add_location(marker, file$7, 26, 2, 528);
    			add_location(defs, file$7, 25, 0, 519);
>>>>>>> testenv
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
...
=======
    		init$1(this, options, instance$b, create_fragment$b, safe_not_equal, { baseEdgeProps: 6 });
>>>>>>> testenv
...
>>>>>>> testenv
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "Anchor svelte-1kxmdm0");
...
<<<<<<< HEAD
    			add_location(div, file$7, 183, 0, 6448);
=======
...
=======
    		init$1(this, options, instance$8, create_fragment$8, safe_not_equal, { key: 20, node: 0, position: 21, role: 1 }, null, [-1, -1]);
>>>>>>> testenv
...
=======
    		init$1(this, options, instance$6, create_fragment$6, safe_not_equal, { edge: 0 });
>>>>>>> testenv
...
=======
    			add_location(img, file$5, 89, 6, 2478);
>>>>>>> testenv
    		},
    		m: function mount(target, anchor) {
...
=======
    			add_location(div, file$5, 52, 0, 1545);
>>>>>>> testenv
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
...
>>>>>>> testenv
    			...
    			if (!mounted) {
    				dispose = [
<<<<<<< HEAD
    					listen_dev(window, "mousemove", /*mousemove_handler*/ ctx[21], false, false, false),
    					listen_dev(window, "mouseup", /*mouseup_handler*/ ctx[22], false, false, false),
    					listen_dev(div, "dblclick", /*dblclick_handler*/ ctx[23], false, false, false),
    					listen_dev(div, "touchmove", /*touchmove_handler*/ ctx[24], false, false, false),
    					listen_dev(div, "touchstart", /*touchstart_handler*/ ctx[25], false, false, false),
    					listen_dev(div, "touchend", /*touchend_handler*/ ctx[26], false, false, false),
    					listen_dev(div, "mousedown", /*mousedown_handler*/ ctx[27], false, false, false)
=======
...
>>>>>>> testenv
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*moving, $movementStore*/ 262148) {
...
<<<<<<< HEAD
    			...
    			t1 = space();
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "image-node");
    			add_location(div, file$4, 20, 0, 728);
...
>>>>>>> testenv
    			...
    			if (!src_url_equal(img.src, img_src_value = /*node*/ ctx[0].src)) attr_dev(img, "src", img_src_value);
<<<<<<< HEAD
    			attr_dev(img, "alt", img_alt_value = /*node*/ ctx[0].alt);
    			attr_dev(img, "id", img_id_value = "svelvet-" + /*node*/ ctx[0].id);
    			add_location(img, file$4, 23, 0, 763);
=======
    			attr_dev(img, "alt", "");
...
<<<<<<< HEAD
    			if (!current || dirty & /*node*/ 1 && img_alt_value !== (img_alt_value = /*node*/ ctx[0].alt)) {
...
>>>>>>> testenv
    ...
    class ImageNode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
<<<<<<< HEAD
    		init$1(this, options, instance$4, create_fragment$4, safe_not_equal, { node: 0, key: 10 });
=======
...
>>>>>>> testenv
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const node_changes = {};
    			if (dirty & /*$nodesStore*/ 16) node_changes.node = /*node*/ ctx[27];
    			if (dirty & /*key*/ 4) node_changes.key = /*key*/ ctx[2];

    			if (dirty & /*$$scope, $nodesStore*/ 1073741840) {
...
>>>>>>> testenv
    function create_default_slot_2(ctx) {
    	let t_value = /*node*/ ctx[27].data.label + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$nodesStore*/ 16 && t_value !== (t_value = /*node*/ ctx[27].data.label + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
...
>>>>>>> testenv
    function create_default_slot_1(ctx) {
    	...
    	let current;
    	var switch_value = /*node*/ ctx[27].data.custom;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (switch_value !== (switch_value = /*node*/ ctx[27].data.custom)) {
    				if (switch_instance) {
    					group_outros();
...
>>>>>>> testenv
    function create_default_slot(ctx) {
    	let html_tag;
    	let raw_value = /*node*/ ctx[27].data.html + "";
    	let html_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$nodesStore*/ 16 && raw_value !== (raw_value = /*node*/ ctx[27].data.html + "")) html_tag.p(raw_value);
    		},
    		d: function destroy(detaching) {
...
>>>>>>> testenv
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
<<<<<<< HEAD
    		if (/*node*/ ctx[27].data.html) return 0;
    		if (/*node*/ ctx[27].data.custom) return 1;
    		return 2;
=======
    		if (/*node*/ ctx[27].image && !/*node*/ ctx[27].data.label) return 0;
    		if (/*node*/ ctx[27].data.html) return 1;
    		if (/*node*/ ctx[27].data.custom) return 2;
    		return 3;
>>>>>>> testenv
    	}
...
<<<<<<< HEAD
    			add_location(rect, file$3, 152, 4, 5738);
=======
    			add_location(rect, file$3, 150, 4, 5627);
>>>>>>> testenv
    		},
    		m: function mount(target, anchor) {
...
=======
    		source: "(150:2) {#if $backgroundStore}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    // (156:4) {#each $derivedEdges as edge}
>>>>>>> testenv
...
=======
    		source: "(156:4) {#each $derivedEdges as edge}",
>>>>>>> testenv
    		ctx
    	});
...
<<<<<<< HEAD
    			add_location(circle, file$3, 141, 6, 5526);
=======
    			add_location(circle, file$3, 139, 6, 5415);
>>>>>>> testenv
...
<<<<<<< HEAD
    			add_location(pattern, file$3, 133, 4, 5367);
    			add_location(defs, file$3, 132, 2, 5356);
    			add_location(g, file$3, 156, 2, 5915);
    			...
    			add_location(svg, file$3, 131, 0, 5275);
=======
    			add_location(pattern, file$3, 131, 4, 5256);
    			add_location(defs, file$3, 130, 2, 5245);
    			add_location(g, file$3, 154, 2, 5804);
    			attr_dev(svg, "class", svg_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-n8qkrl"));
    			attr_dev(svg, "viewBox", svg_viewBox_value = "0 0 " + /*$widthStore*/ ctx[5] + " " + /*$heightStore*/ ctx[6]);
    			add_location(svg, file$3, 129, 0, 5164);
>>>>>>> testenv
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
...
<<<<<<< HEAD
    			if (!current || dirty & /*key*/ 4 && div0_class_value !== (div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-1nam3pu"))) {
=======
    			if (!current || dirty & /*key*/ 4 && div0_class_value !== (div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-n8qkrl"))) {
>>>>>>> testenv
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (!current || dirty & /*key*/ 4 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`Nodes Nodes-${/*key*/ ctx[2]}`) + " svelte-1nam3pu"))) {
    			...
    			if (!current || dirty & /*key*/ 4 && svg_class_value !== (svg_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-1nam3pu"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	d3.select('.Nodes').on('mousemove', event => {
    		store.mouseX.set(d3.pointer(event)[0]);
    		store.mouseY.set(d3.pointer(event)[1]);
    	});
...
<<<<<<< HEAD
    			...
    			add_location(h1, file, 92, 1, 2025);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 93, 14, 2062);
    			add_location(p, file, 93, 1, 2049);
    			attr_dev(main, "class", "svelte-cydqi");
    			add_location(main, file, 91, 0, 2017);
=======
