...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "Anchor svelte-jk37g5");

    			attr_dev(div, "style", `
    height:${/*anchorHeight*/ ctx[11]}px;
    width:${/*anchorWidth*/ ctx[10]}px;
    top: ${/*top*/ ctx[16]}px;
    left:${/*left*/ ctx[17]}px;
  `);

    			add_location(div, file$7, 184, 0, 6568);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "mouseup", /*mouseup_handler_1*/ ctx[25], false, false, false),
    					listen_dev(div, "mouseenter", /*mouseenter_handler*/ ctx[26], false, false, false),
    					listen_dev(div, "mouseleave", /*mouseleave_handler*/ ctx[27], false, false, false)
    				];
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, derivedEdges, value => $$invalidate(8, $derivedEdges = value));
    	validate_store(nodesStore, 'nodesStore');
    	component_subscribe($$self, nodesStore, value => $$invalidate(29, $nodesStore = value));
    ...
    */
    	const renderNewNode = (event, edge) => {
    		event.preventDefault();
    		setNewEdgeProps(role, position, node);
    		...
    		newNode = {
    			id: v4(), // again, better id generation needed, uuid?
    	...
    	const writable_props = ['key', 'node', 'position', 'role'];
    	...
    	const mouseup_handler_1 = e => {
    		e.preventDefault();
    		$$invalidate(6, edgeShouldMove = false);
    		$$invalidate(4, moving = false);
    		$$invalidate(5, moved = false);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('anchorWidth' in $$props) $$invalidate(10, anchorWidth = $$props.anchorWidth);
    		if ('anchorHeight' in $$props) $$invalidate(11, anchorHeight = $$props.anchorHeight);
    		if ('moving' in $$props) $$invalidate(4, moving = $$props.moving);
    		if ('moved' in $$props) $$invalidate(5, moved = $$props.moved);
    		if ('edgeShouldMove' in $$props) $$invalidate(6, edgeShouldMove = $$props.edgeShouldMove);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*key*/ 1048576) {
    			$$invalidate(7, store = findOrCreateStore(key));
    		}
    	};
    ...
    class EdgeAnchor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$9, create_fragment$9, safe_not_equal, { key: 20, node: 0, position: 21, role: 1 }, null, [-1, -1]);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "nodes svelte-1diau6n");
    			set_style(div, "top", /*top*/ ctx[0] + "px");
    			set_style(div, "left", /*left*/ ctx[1] + "px");
    			set_style(div, "height", /*nHeight*/ ctx[3] + "px");
    			set_style(div, "width", /*nWidth*/ ctx[2] + "px");
    			add_location(div, file$6, 29, 0, 847);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let { nodeMidpoint } = $$props;
    	let { mapMidpoint } = $$props;
    	...
    	$$self.$$.on_mount.push(function () {
    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console_1$1.warn("<GreyNode> was created without expected prop 'key'");
    		}

    		if (node === undefined && !('node' in $$props || $$self.$$.bound[$$self.$$.props['node']])) {
    			console_1$1.warn("<GreyNode> was created without expected prop 'node'");
    		}

    		if (heightRatio === undefined && !('heightRatio' in $$props || $$self.$$.bound[$$self.$$.props['heightRatio']])) {
    			console_1$1.warn("<GreyNode> was created without expected prop 'heightRatio'");
    		}

    		if (widthRatio === undefined && !('widthRatio' in $$props || $$self.$$.bound[$$self.$$.props['widthRatio']])) {
    			console_1$1.warn("<GreyNode> was created without expected prop 'widthRatio'");
    		}

    		if (nodeMidpoint === undefined && !('nodeMidpoint' in $$props || $$self.$$.bound[$$self.$$.props['nodeMidpoint']])) {
    			console_1$1.warn("<GreyNode> was created without expected prop 'nodeMidpoint'");
    		}

    		if (mapMidpoint === undefined && !('mapMidpoint' in $$props || $$self.$$.bound[$$self.$$.props['mapMidpoint']])) {
    			console_1$1.warn("<GreyNode> was created without expected prop 'mapMidpoint'");
    		}
    	});

    	const writable_props = ['key', 'node', 'heightRatio', 'widthRatio', 'nodeMidpoint', 'mapMidpoint'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<GreyNode> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('nodeMidpoint' in $$props) $$invalidate(8, nodeMidpoint = $$props.nodeMidpoint);
    		if ('mapMidpoint' in $$props) $$invalidate(9, mapMidpoint = $$props.mapMidpoint);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('nWidth' in $$props) $$invalidate(2, nWidth = $$props.nWidth);
    		if ('nHeight' in $$props) $$invalidate(3, nHeight = $$props.nHeight);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*mapMidpoint, nodeMidpoint, node, heightRatio, widthRatio*/ 992) {
    			{
    				console.log('mapmidpoint ', mapMidpoint);
    				console.log('nodemidpoint ', nodeMidpoint);
    				$$invalidate(0, top = node.position.y * heightRatio);
    				$$invalidate(1, left = node.position.x * heightRatio);
    				$$invalidate(3, nHeight = node.height * heightRatio);
    				$$invalidate(2, nWidth = node.width * widthRatio);
    			}
    		}
    	};
    ...
    function create_each_block$1(ctx) {
    	...
    	greynode = new GreyNode({
    			props: {
    				node: /*node*/ ctx[18],
    				key: /*key*/ ctx[0],
    				heightRatio: /*heightRatio*/ ctx[4],
    				widthRatio: /*widthRatio*/ ctx[5],
    				mapMidpoint: /*mapMidpoint*/ ctx[7],
    				nodeMidpoint: /*nodeMidpoint*/ ctx[6]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$nodesStore*/ 8) greynode_changes.node = /*node*/ ctx[18];
    			if (dirty & /*key*/ 1) greynode_changes.key = /*key*/ ctx[0];
    			if (dirty & /*heightRatio*/ 16) greynode_changes.heightRatio = /*heightRatio*/ ctx[4];
    			if (dirty & /*widthRatio*/ 32) greynode_changes.widthRatio = /*widthRatio*/ ctx[5];
    			if (dirty & /*mapMidpoint*/ 128) greynode_changes.mapMidpoint = /*mapMidpoint*/ ctx[7];
    			if (dirty & /*nodeMidpoint*/ 64) greynode_changes.nodeMidpoint = /*nodeMidpoint*/ ctx[6];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(100:8) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	let div;
    	let current;
    	let each_value = /*$nodesStore*/ ctx[3];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "" + (null_to_empty(`miniMap`) + " svelte-ilib2s"));
    			set_style(div, "height", /*mapHeight*/ ctx[2] + "px");
    			set_style(div, "width", /*mapWidth*/ ctx[1] + "px");
    			add_location(div, file$5, 98, 4, 3527);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$nodesStore, key, heightRatio, widthRatio, mapMidpoint, nodeMidpoint*/ 249) {
    				each_value = /*$nodesStore*/ ctx[3];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	validate_store(nodesStore, 'nodesStore');
    	component_subscribe($$self, nodesStore, value => $$invalidate(3, $nodesStore = value));
    	...
    	$$self.$inject_state = $$props => {
    		if ('key' in $$props) $$invalidate(0, key = $$props.key);
    		if ('firstGo' in $$props) $$invalidate(9, firstGo = $$props.firstGo);
    		...
    		if ('nodeHeight' in $$props) $$invalidate(10, nodeHeight = $$props.nodeHeight);
    		if ('nodeWidth' in $$props) $$invalidate(11, nodeWidth = $$props.nodeWidth);
    		if ('heightRatio' in $$props) $$invalidate(4, heightRatio = $$props.heightRatio);
    		if ('widthRatio' in $$props) $$invalidate(5, widthRatio = $$props.widthRatio);
    		if ('nodeMidpoint' in $$props) $$invalidate(6, nodeMidpoint = $$props.nodeMidpoint);
    		if ('mapMidpoint' in $$props) $$invalidate(7, mapMidpoint = $$props.mapMidpoint);
    		if ('nodeXleftPosition' in $$props) $$invalidate(12, nodeXleftPosition = $$props.nodeXleftPosition);
    		if ('nodeYtopPosition' in $$props) $$invalidate(13, nodeYtopPosition = $$props.nodeYtopPosition);
    		if ('nodeYbottomPosition' in $$props) $$invalidate(14, nodeYbottomPosition = $$props.nodeYbottomPosition);
    		if ('nodeXrightPosition' in $$props) $$invalidate(15, nodeXrightPosition = $$props.nodeXrightPosition);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*firstGo, $nodesStore, nodeXleftPosition, nodeXrightPosition, nodeYbottomPosition, nodeYtopPosition, nodeWidth, nodeHeight, mapWidth, mapHeight*/ 65038) {
    			// reactive object that updates every time nodesStore is updated
    			{
    				if (firstGo) {
    					//sets initial position values for furthest nodes
    					$nodesStore.forEach(node => {
    						$$invalidate(12, nodeXleftPosition = Math.min(nodeXleftPosition, node.position.x));
    						$$invalidate(15, nodeXrightPosition = Math.max(nodeXrightPosition, node.position.x));
    						$$invalidate(14, nodeYbottomPosition = Math.min(nodeYbottomPosition, node.position.y));
    						$$invalidate(13, nodeYtopPosition = Math.max(nodeYtopPosition, node.position.y));
    					});

    					// set height and width
    					$$invalidate(10, nodeHeight = nodeYtopPosition - nodeYbottomPosition);

    					$$invalidate(11, nodeWidth = nodeXrightPosition - nodeXleftPosition);

    					// reassign midpoint
    					$$invalidate(6, nodeMidpoint = { x: nodeWidth / 2, y: nodeHeight / 2 });

    					//ends the first round
    					$$invalidate(9, firstGo = !firstGo);
    				} else {
    					//reassign node positions for reassignment within updated store
    					$$invalidate(12, nodeXleftPosition = Infinity);

    					$$invalidate(13, nodeYtopPosition = -Infinity);
    					$$invalidate(14, nodeYbottomPosition = Infinity);
    					$$invalidate(15, nodeXrightPosition = -Infinity);
    					...
    					$$invalidate(10, nodeHeight = Math.abs(nodeYbottomPosition - nodeYtopPosition));

    					$$invalidate(11, nodeWidth = Math.abs(nodeXleftPosition - nodeXrightPosition));
    					$$invalidate(6, nodeMidpoint = { x: nodeWidth / 2, y: nodeHeight / 2 });
    				}
    				...
    				$$invalidate(7, mapMidpoint = { x: mapWidth / 2, y: mapHeight / 2 });
    				$$invalidate(4, heightRatio = ((mapHeight - 20) / nodeHeight).toFixed(2));
    				$$invalidate(5, widthRatio = ((mapWidth - 20) / nodeWidth).toFixed(2));
    			}
    		}
    	};
    ...
    class Minimap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$5, create_fragment$5, safe_not_equal, { key: 0 });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 88, 6, 2480);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "Node svelte-1u7y2cz");
    			...
    			add_location(div, file$4, 51, 0, 1547);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "touchmove", /*touchmove_handler*/ ctx[21], false, false, false),
    					listen_dev(div, "touchstart", /*touchstart_handler*/ ctx[22], false, false, false),
    					listen_dev(div, "touchend", /*touchend_handler*/ ctx[23], false, false, false),
    					listen_dev(div, "mousedown", /*mousedown_handler*/ ctx[24], false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let { node } = $$props;
    	let { key } = $$props;
    	const { onNodeMove, onNodeClick, onTouchMove, nodeSelected, widthStore, heightStore, nodeIdSelected, movementStore, snapgrid, snapResize, derivedEdges } = findOrCreateStore(key);
    	validate_store(nodeSelected, 'nodeSelected');
    	component_subscribe($$self, nodeSelected, value => $$invalidate(7, $nodeSelected = value));
    	...
    	component_subscribe($$self, movementStore, value => $$invalidate(16, $movementStore = value));
    	validate_store(snapgrid, 'snapgrid');
    	component_subscribe($$self, snapgrid, value => $$invalidate(5, $snapgrid = value));
    	validate_store(snapResize, 'snapResize');
    	component_subscribe($$self, snapResize, value => $$invalidate(6, $snapResize = value));
    	...
    	const mouseup_handler = e => {
    		...
    		if (!moved && node.id == $nodeIdSelected) ; // onNodeClick(e, node.id);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('shouldMove' in $$props) $$invalidate(4, shouldMove = $$props.shouldMove);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*moving, $movementStore*/ 65540) {
    			$$invalidate(4, shouldMove = moving && $movementStore);
    		}
    	};
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const node_changes = {};
    			if (dirty[0] & /*$nodesStore*/ 16) node_changes.node = /*node*/ ctx[29];
    			if (dirty[0] & /*key*/ 4) node_changes.key = /*key*/ ctx[2];

    			if (dirty[0] & /*$nodesStore*/ 16 | dirty[1] & /*$$scope*/ 2) {
    ...
    // (112:6) {#if node.image && !node.data.label}
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$nodesStore*/ 16) imagenode_changes.node = /*node*/ ctx[29];
    			if (dirty[0] & /*key*/ 4) imagenode_changes.key = /*key*/ ctx[2];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(112:6) {#if node.image && !node.data.label}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	let t_value = /*node*/ ctx[29].data.label + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*$nodesStore*/ 16 && t_value !== (t_value = /*node*/ ctx[29].data.label + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    ...
    function create_default_slot(ctx) {
    	let html_tag;
    	let raw_value = /*node*/ ctx[29].data.html + "";
    	let html_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*$nodesStore*/ 16 && raw_value !== (raw_value = /*node*/ ctx[29].data.html + "")) html_tag.p(raw_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*node*/ ctx[29].image && !/*node*/ ctx[29].data.label) return 0;
    		if (/*node*/ ctx[29].data.html) return 1;
    		return 2;
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(111:4) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$2, 146, 4, 5514);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(146:2) {#if $backgroundStore}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$derivedEdges*/ 128) simplebezieredge_changes.edge = /*edge*/ ctx[26];
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$derivedEdges*/ 128) stepedge_changes.edge = /*edge*/ ctx[26];
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const smoothstepedge_changes = {};
    			if (dirty[0] & /*$derivedEdges*/ 128) smoothstepedge_changes.edge = /*edge*/ ctx[26];
    			smoothstepedge.$set(smoothstepedge_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$derivedEdges*/ 128) straightedge_changes.edge = /*edge*/ ctx[26];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(153:6) {#if edge.type === 'straight'}",
    		ctx
    	});
    ...
    // (152:4) {#each $derivedEdges as edge}
    function create_each_block(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*edge*/ ctx[26].type === 'straight') return 0;
    		if (/*edge*/ ctx[26].type === 'smoothstep') return 1;
    		if (/*edge*/ ctx[26].type === 'step') return 2;
    		return 3;
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(152:4) {#each $derivedEdges as edge}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$2, 135, 6, 5302);
    			...
    			add_location(pattern, file$2, 127, 4, 5143);
    			add_location(defs, file$2, 126, 2, 5132);
    			add_location(g, file$2, 150, 2, 5691);
    			...
    			add_location(svg, file$2, 125, 0, 5051);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div1, "contextmenu", prevent_default(/*contextmenu_handler*/ ctx[15]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			const minimap_changes = {};
    			if (dirty[0] & /*key*/ 4) minimap_changes.key = /*key*/ ctx[2];
    			minimap.$set(minimap_changes);
    			...
    			if (!current || dirty[0] & /*key*/ 4 && div0_class_value !== (div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-n8qkrl"))) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (!current || dirty[0] & /*key*/ 4 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`Nodes Nodes-${/*key*/ ctx[2]}`) + " svelte-n8qkrl"))) {
    			...
    			if (!current || dirty[0] & /*key*/ 4 && svg_class_value !== (svg_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-n8qkrl"))) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	validate_store(nodeSelected, 'nodeSelected');
    	component_subscribe($$self, nodeSelected, value => $$invalidate(17, $nodeSelected = value));
    	...
    	const writable_props = ['nodesStore', 'derivedEdges', 'key', 'initialZoom', 'initialLocation'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('initialZoom' in $$props) $$invalidate(13, initialZoom = $$props.initialZoom);
    		if ('initialLocation' in $$props) $$invalidate(14, initialLocation = $$props.initialLocation);
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	graphview = new GraphView({
    			props: {
    				nodesStore: /*nodesStore*/ ctx[8],
    				derivedEdges: /*derivedEdges*/ ctx[9],
    				key: /*key*/ ctx[5],
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 57, 0, 2612);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$widthStore, $heightStore, $backgroundColor*/ 28 && div_style_value !== (div_style_value = `width: ${/*$widthStore*/ ctx[2]}px; height: ${/*$heightStore*/ ctx[3]}px; background-color: ${/*$backgroundColor*/ ctx[4]}`)) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_store(widthStore, 'widthStore');
    	component_subscribe($$self, widthStore, value => $$invalidate(2, $widthStore = value));
    	validate_store(heightStore, 'heightStore');
    	component_subscribe($$self, heightStore, value => $$invalidate(3, $heightStore = value));
    	validate_store(backgroundColor, 'backgroundColor');
    	component_subscribe($$self, backgroundColor, value => $$invalidate(4, $backgroundColor = value));
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('movement' in $$props) $$invalidate(16, movement = $$props.movement);
    		if ('snap' in $$props) $$invalidate(17, snap = $$props.snap);
    		if ('snapTo' in $$props) $$invalidate(18, snapTo = $$props.snapTo);
    		if ('bgColor' in $$props) $$invalidate(19, bgColor = $$props.bgColor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 136, 1, 2926);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 137, 14, 2963);
    			add_location(p, file, 137, 1, 2950);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 135, 0, 2918);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
