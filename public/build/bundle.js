...
var app = (function () {
  ...
  `);
    			...
    			add_location(div, file$b, 111, 0, 3408);
    		},
    		m: function mount(target, anchor) {
  ...
  `)) {
    ...
    `);
    			...
    			add_location(div, file$b, 76, 2, 2393);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	let top;
    	let left;
    	const { onEdgeMove, setAnchorPosition, setNewEdgeProps, renderEdge, renderNewNode, hoveredElement, derivedEdges, nodeLinkStore, nodeCreateStore } = findOrCreateStore(key);
    	...
    	component_subscribe($$self, derivedEdges, value => $$invalidate(12, $derivedEdges = value));
    	...
    	component_subscribe($$self, nodeCreateStore, value => $$invalidate(13, $nodeCreateStore = value));
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 140, 4, 3555);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$7, 137, 6, 3499);
    			add_location(div, file$7, 136, 4, 3487);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$7, 128, 6, 3286);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 77, 0, 2061);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	let nodeWidth;
    	let nodeHeight;
    	const { onNodeMove, onNodeClick, onTouchMove, getStyles, nodeSelected, nodeIdSelected, movementStore, snapgrid, snapResize, isLocked, nodeEditStore } = findOrCreateStore(key);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-10tufje"));
    			add_location(div0, file$3, 225, 2, 8668);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(`Nodes Nodes-${/*key*/ ctx[2]}`) + " svelte-10tufje"));
    			...
    			attr_dev(pattern, "class", "svelte-10tufje");
    			add_location(pattern, file$3, 247, 4, 9465);
    			add_location(defs, file$3, 246, 2, 9454);
    			add_location(g0, file$3, 270, 2, 10013);
    			attr_dev(svg0, "class", svg0_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-10tufje"));
    			attr_dev(svg0, "viewBox", svg0_viewBox_value = "0 0 " + /*$widthStore*/ ctx[9] + " " + /*$heightStore*/ ctx[10]);
    			add_location(svg0, file$3, 245, 0, 9373);
    			attr_dev(div2, "id", "dwnld-btn");
    			add_location(div2, file$3, 293, 2, 10664);
    			attr_dev(g1, "id", "SVGRepo_bgCarrier");
    			attr_dev(g1, "stroke-width", "0");
    			add_location(g1, file$3, 294, 143, 10834);
    			attr_dev(path0, "d", "M0 0h48v48H0z");
    			attr_dev(path0, "fill", "none");
    			add_location(path0, file$3, 294, 219, 10910);
    			attr_dev(polygon, "points", "22,4 22,20 14,20 24,30 34,20 26,20 26,4 ");
    			add_location(polygon, file$3, 294, 281, 10972);
    			attr_dev(path1, "d", "M8,44h32c2.206,0,4-1.794,4-4V30h-4v10H8V30H4v10C4,42.206,5.794,44,8,44z");
    			add_location(path1, file$3, 294, 351, 11042);
    			attr_dev(g2, "id", "Shopicon");
    			add_location(g2, file$3, 294, 263, 10954);
    			attr_dev(g3, "id", "SVGRepo_iconCarrier");
    			add_location(g3, file$3, 294, 190, 10881);
    			attr_dev(svg1, "id", "dwnldimg");
    			attr_dev(svg1, "viewBox", "0 0 48 48");
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "fill", "#000000");
    			attr_dev(svg1, "class", "svelte-10tufje");
    			add_location(svg1, file$3, 294, 54, 10745);
    			attr_dev(a, "id", "downloadState");
    			attr_dev(a, "download", "svelvet-state.json");
    			add_location(a, file$3, 294, 2, 10693);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "store-input");
    			attr_dev(input, "placeholder", "Paste JSON here");
    			attr_dev(input, "class", "svelte-10tufje");
    			add_location(input, file$3, 295, 2, 11154);
    			attr_dev(button, "id", "store-input-btn");
    			attr_dev(button, "class", "svelte-10tufje");
    			add_location(button, file$3, 296, 1, 11222);
    			attr_dev(div3, "id", "export-import");
    			attr_dev(div3, "class", "svelte-10tufje");
    			add_location(div3, file$3, 292, 0, 10637);
    			attr_dev(div4, "id", "graphview-container");
    			attr_dev(div4, "class", "svelte-10tufje");
    			add_location(div4, file$3, 213, 2, 8142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div4, t0);
    			mount_component(editmodal, div4, null);
    			append_dev(div4, t1);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*key*/ 4 && div0_class_value !== (div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-10tufje"))) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (!current || dirty[0] & /*key*/ 4 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`Nodes Nodes-${/*key*/ ctx[2]}`) + " svelte-10tufje"))) {
    				attr_dev(div1, "class", div1_class_value);
    			}
    			...
    			if (!current || dirty[0] & /*key*/ 4 && svg0_class_value !== (svg0_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-10tufje"))) {
    				attr_dev(svg0, "class", svg0_class_value);
    			}

    			if (!current || dirty[0] & /*$widthStore, $heightStore*/ 1536 && svg0_viewBox_value !== (svg0_viewBox_value = "0 0 " + /*$widthStore*/ ctx[9] + " " + /*$heightStore*/ ctx[10])) {
