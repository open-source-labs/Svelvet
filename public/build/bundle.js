...
=======
    ...
    // (111:0) {:else}
>>>>>>> b303fc1f1cdb6b82fa618c2b222ad4cd7641b1d0
...
<<<<<<< HEAD
    			add_location(div, file$a, 113, 0, 3490);
=======
...
<<<<<<< HEAD
    			add_location(div, file$a, 77, 2, 2488);
=======
...
>>>>>>> b303fc1f1cdb6b82fa618c2b222ad4cd7641b1d0
    ...
    const file$9 = "svelvetrabbit/Nodes/EditModal.svelte";
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$9, 71, 4, 2277);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", input0_id_value = "label-input-$" + /*key*/ ctx[0]);

    			attr_dev(input0, "placeholder", input0_placeholder_value = /*currentNode*/ ctx[5].data.label
    			? /*currentNode*/ ctx[5].data.label
    			: 'None');

    			attr_dev(input0, "class", "svelte-1ijtz81");
    			add_location(input0, file$9, 72, 4, 2320);
    			attr_dev(label1, "for", "width-input");
    			attr_dev(label1, "class", "svelte-1ijtz81");
    			add_location(label1, file$9, 73, 4, 2464);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", input1_id_value = "width-input-$" + /*key*/ ctx[0]);
    			attr_dev(input1, "placeholder", input1_placeholder_value = /*currentNode*/ ctx[5].width);
    			attr_dev(input1, "class", "svelte-1ijtz81");
    			add_location(input1, file$9, 74, 4, 2507);
    			attr_dev(label2, "for", "height-input");
    			attr_dev(label2, "class", "svelte-1ijtz81");
    			add_location(label2, file$9, 75, 4, 2610);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "id", input2_id_value = "height-input-$" + /*key*/ ctx[0]);
    			attr_dev(input2, "placeholder", input2_placeholder_value = /*currentNode*/ ctx[5].height);
    			attr_dev(input2, "class", "svelte-1ijtz81");
    			add_location(input2, file$9, 76, 4, 2655);
    			attr_dev(label3, "for", "bg-color-input");
    			attr_dev(label3, "class", "svelte-1ijtz81");
    			add_location(label3, file$9, 77, 4, 2761);
    			...
    			add_location(input3, file$9, 78, 4, 2818);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "placeholder", input4_placeholder_value = /*currentNode*/ ctx[5].bgColor);
    			attr_dev(input4, "class", "svelte-1ijtz81");
    			add_location(input4, file$9, 79, 4, 2900);
    			attr_dev(label4, "for", "custom-class-input");
    			attr_dev(label4, "class", "svelte-1ijtz81");
    			add_location(label4, file$9, 80, 4, 2989);
    			attr_dev(input5, "type", "text");
    			attr_dev(input5, "id", input5_id_value = "custom-class-input-$" + /*key*/ ctx[0]);

    			attr_dev(input5, "placeholder", input5_placeholder_value = /*currentNode*/ ctx[5].className
    			? /*currentNode*/ ctx[5].className
    			: 'None');

    			attr_dev(input5, "class", "svelte-1ijtz81");
    			add_location(input5, file$9, 81, 4, 3046);
    			attr_dev(form, "class", "svelte-1ijtz81");
    			add_location(form, file$9, 70, 2, 2245);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input3, /*backgroundColor*/ ctx[4]);
    			append_dev(form, t11);
    			append_dev(form, input4);
    			set_input_value(input4, /*backgroundColor*/ ctx[4]);
    			append_dev(form, t12);
    			append_dev(form, label4);
    			append_dev(form, t14);
    			append_dev(form, input5);
    			set_input_value(input5, /*customClass*/ ctx[3]);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*changeLabel*/ ctx[9], false, false, false),
    					...
    					listen_dev(form, "submit", /*editNode*/ ctx[8], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*currentNode*/ 32 && input0_placeholder_value !== (input0_placeholder_value = /*currentNode*/ ctx[5].data.label
    			? /*currentNode*/ ctx[5].data.label
    			: 'None')) {
    			...
    			if (dirty & /*currentNode*/ 32 && input1_placeholder_value !== (input1_placeholder_value = /*currentNode*/ ctx[5].width)) {
    			...
    			if (dirty & /*currentNode*/ 32 && input2_placeholder_value !== (input2_placeholder_value = /*currentNode*/ ctx[5].height)) {
    			...
    			if (dirty & /*currentNode*/ 32 && input4_placeholder_value !== (input4_placeholder_value = /*currentNode*/ ctx[5].bgColor)) {
    				attr_dev(input4, "placeholder", input4_placeholder_value);
    			}

    			if (dirty & /*backgroundColor*/ 16 && input4.value !== /*backgroundColor*/ ctx[4]) {
    				set_input_value(input4, /*backgroundColor*/ ctx[4]);
    			}
    			...
    			if (dirty & /*currentNode*/ 32 && input5_placeholder_value !== (input5_placeholder_value = /*currentNode*/ ctx[5].className
    			? /*currentNode*/ ctx[5].className
    			: 'None')) {
    				attr_dev(input5, "placeholder", input5_placeholder_value);
    			}

    			if (dirty & /*customClass*/ 8 && input5.value !== /*customClass*/ ctx[3]) {
    				set_input_value(input5, /*customClass*/ ctx[3]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$9(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*currentNode*/ ctx[5] && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$9, 68, 2, 2198);
    			attr_dev(button, "class", "svelte-1ijtz81");
    			add_location(button, file$9, 84, 2, 3213);
    			attr_dev(div, "class", div_class_value = "edit-modal edit-modal-" + /*key*/ ctx[0] + " svelte-1ijtz81");
    			add_location(div, file$9, 67, 0, 2154);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*editNode*/ ctx[8], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (/*currentNode*/ ctx[5]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    			...
    			if (dirty & /*key*/ 1 && div_class_value !== (div_class_value = "edit-modal edit-modal-" + /*key*/ ctx[0] + " svelte-1ijtz81")) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('currentNode' in $$props) $$invalidate(5, currentNode = $$props.currentNode);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$nodesStore, $nodeIdSelected*/ 3072) {
    			$$invalidate(5, currentNode = $nodesStore.filter(n => n.id === $nodeIdSelected)[0]);
    		}
    	};
    ...
    class EditModal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$9, create_fragment$9, safe_not_equal, { key: 0 });
    ...
    const file$8 = "svelvetrabbit/Containers/Minimap/GreyNodeBoundless.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 21, 0, 531);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "svelvetrabbit/Containers/Minimap/MinimapBoundless.svelte";
    ...
    class MinimapBoundless extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$7, create_fragment$7, safe_not_equal, { key: 0, d3Translate: 17 }, null, [-1, -1]);
    ...
    const file$6 = "svelvetrabbit/Nodes/index.svelte";
...
<<<<<<< HEAD
    			add_location(div, file$6, 144, 6, 3627);
=======
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
<<<<<<< HEAD
    			add_location(p, file$6, 141, 8, 3567);
    			add_location(div, file$6, 140, 6, 3553);
=======
...
<<<<<<< HEAD
    			add_location(img, file$6, 132, 6, 3350);
=======
...
>>>>>>> b303fc1f1cdb6b82fa618c2b222ad4cd7641b1d0
    ...
    function create_each_block(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	const if_block_creators = [create_if_block_1, create_if_block_2, create_if_block_3, create_else_block$1];
    	const if_blocks = [];
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-lboc8m");
    			add_location(img, file$3, 292, 62, 10861);
    			attr_dev(a, "id", a_id_value = "downloadState-" + /*key*/ ctx[2]);
    			attr_dev(a, "download", "svelvet-state.json");
    			attr_dev(a, "class", "svelte-lboc8m");
    			add_location(a, file$3, 292, 4, 10803);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "store-input");
    			attr_dev(input, "placeholder", "Paste JSON here");
    			attr_dev(input, "class", "svelte-lboc8m");
    			add_location(input, file$3, 293, 4, 10967);
    			attr_dev(button, "id", "store-input-btn");
    			attr_dev(button, "class", "svelte-lboc8m");
    			add_location(button, file$3, 294, 4, 11038);
    			attr_dev(div, "id", "export-import");
    			attr_dev(div, "class", "svelte-lboc8m");
...
<<<<<<< HEAD
    			...
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-lboc8m"));
    			add_location(div0, file$3, 225, 4, 8738);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(`Nodes Nodes-${/*key*/ ctx[2]}`) + " svelte-lboc8m"));
...
<<<<<<< HEAD
    			attr_dev(pattern, "class", "svelte-lboc8m");
    			add_location(pattern, file$3, 244, 6, 9433);
    			add_location(defs, file$3, 243, 4, 9420);
    			add_location(g, file$3, 267, 4, 10023);
    			attr_dev(svg, "class", svg_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-lboc8m"));
    			...
    			attr_dev(div2, "class", "svelte-lboc8m");
...
<<<<<<< HEAD
    			if (!current || dirty[0] & /*key*/ 4 && div0_class_value !== (div0_class_value = "" + (null_to_empty(`Node Node-${/*key*/ ctx[2]}`) + " svelte-lboc8m"))) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (!current || dirty[0] & /*key*/ 4 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`Nodes Nodes-${/*key*/ ctx[2]}`) + " svelte-lboc8m"))) {
=======
...
<<<<<<< HEAD
    			if (!current || dirty[0] & /*key*/ 4 && svg_class_value !== (svg_class_value = "" + (null_to_empty(`Edges Edges-${/*key*/ ctx[2]}`) + " svelte-lboc8m"))) {
