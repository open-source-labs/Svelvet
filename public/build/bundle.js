...
var app = (function () {
  ...
  `)) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			label3.textContent = "Custom Class";
    			t10 = space();
    			input3 = element("input");
    			attr_dev(label0, "for", "label-input");
    			attr_dev(label0, "class", "svelte-hyh7vm");
    			add_location(label0, file$a, 58, 4, 1814);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "label-input");
    			attr_dev(input0, "class", "svelte-hyh7vm");
    			add_location(input0, file$a, 59, 4, 1857);
    			attr_dev(label1, "for", "width-input");
    			attr_dev(label1, "class", "svelte-hyh7vm");
    			add_location(label1, file$a, 60, 4, 1917);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "width-input");
    			add_location(input1, file$a, 61, 4, 1960);
    			attr_dev(label2, "for", "height-input");
    			attr_dev(label2, "class", "svelte-hyh7vm");
    			add_location(label2, file$a, 62, 4, 2020);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "height-input");
    			add_location(input2, file$a, 63, 4, 2065);
    			attr_dev(label3, "for", "custom-class-input");
    			attr_dev(label3, "class", "svelte-hyh7vm");
    			add_location(label3, file$a, 64, 4, 2127);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "id", "custom-class-input");
    			add_location(input3, file$a, 65, 4, 2184);
    			add_location(form, file$a, 57, 2, 1779);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input3, /*customClass*/ ctx[3]);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", /*changeLabel*/ ctx[7], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*customClass*/ 8 && input3.value !== /*customClass*/ ctx[3]) {
    				set_input_value(input3, /*customClass*/ ctx[3]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$a, 55, 2, 1732);
    			attr_dev(button, "class", "svelte-hyh7vm");
    			add_location(button, file$a, 68, 2, 2273);
    			attr_dev(div, "class", "edit-modal svelte-hyh7vm");
    			add_location(div, file$a, 54, 0, 1705);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*changeLabel*/ ctx[7], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, nodesStore, value => $$invalidate(9, $nodesStore = value));
    	validate_store(nodeIdSelected, 'nodeIdSelected');
    	component_subscribe($$self, nodeIdSelected, value => $$invalidate(10, $nodeIdSelected = value));
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$nodesStore, $nodeIdSelected*/ 1536) {
    ...
    class EditModal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$a, create_fragment$a, safe_not_equal, { key: 8 });
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 192, 4, 6043);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "node-label svelte-hwr169");
    			add_location(p, file$7, 189, 6, 5928);
    			add_location(div, file$7, 188, 4, 5916);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$7, 180, 6, 5715);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", div_class_value = "Node " + (/*node*/ ctx[0].className || '') + " svelte-hwr169");
    			...
    			add_location(div, file$7, 131, 0, 4521);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "contextmenu", /*contextmenu_handler*/ ctx[29], false, false, false),
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*node*/ 1 && div_class_value !== (div_class_value = "Node " + (/*node*/ ctx[0].className || '') + " svelte-hwr169")) {
    				attr_dev(div, "class", div_class_value);
    			}
    ...
    function create_if_block_6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(185:0) {#if minimap && boundary}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(199:6) {#if node.data.html}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(194:4) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$3, 233, 4, 8378);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(233:2) {#if $backgroundStore}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(240:6) {#if edge.type === 'straight'}",
    		ctx
    	});
    ...
    // (239:4) {#each $derivedEdges as edge}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(239:4) {#each $derivedEdges as edge}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$3, 222, 6, 8166);
    			...
    			add_location(pattern, file$3, 214, 4, 8007);
    			add_location(defs, file$3, 213, 2, 7996);
    			add_location(g, file$3, 237, 2, 8555);
    			...
    			add_location(svg, file$3, 212, 0, 7915);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div1, "contextmenu", prevent_default(/*contextmenu_handler*/ ctx[21]), false, true, false),
    					listen_dev(div1, "click", /*closeEditModal*/ ctx[16], false, false, false)
    				];
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 67, 0, 2913);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('movement' in $$props) $$invalidate(20, movement = $$props.movement);
    		if ('snap' in $$props) $$invalidate(21, snap = $$props.snap);
    		if ('snapTo' in $$props) $$invalidate(22, snapTo = $$props.snapTo);
    		if ('bgColor' in $$props) $$invalidate(23, bgColor = $$props.bgColor);
    		...
    		if ('locked' in $$props) $$invalidate(24, locked = $$props.locked);
