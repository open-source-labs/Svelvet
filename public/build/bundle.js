...
var app = (function () {
  ...
  `);
    ...
    */
    ...
    // (121:6) {#if node.image && !node.data.label}
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$nodesStore*/ 64) imagenode_changes.node = /*node*/ ctx[29];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(121:6) {#if node.image && !node.data.label}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(120:4) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$2, 155, 4, 5870);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(155:2) {#if $backgroundStore}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(162:6) {#if edge.type === 'straight'}",
    		ctx
    	});
    ...
    // (161:4) {#each $derivedEdges as edge}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(161:4) {#each $derivedEdges as edge}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$2, 144, 6, 5658);
    			...
    			add_location(pattern, file$2, 136, 4, 5499);
    			add_location(defs, file$2, 135, 2, 5488);
    			add_location(g, file$2, 159, 2, 6047);
    			...
    			add_location(svg, file$2, 134, 0, 5407);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 58, 0, 2640);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
