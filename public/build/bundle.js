...
var app = (function () {
  ...
  `)) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (node === undefined && !('node' in $$props || $$self.$$.bound[$$self.$$.props['node']])) {
    			console_1$4.warn("<Nodes> was created without expected prop 'node'");
    		}

    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console_1$4.warn("<Nodes> was created without expected prop 'key'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$4.warn(`<Nodes> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "height", /*nHeight*/ ctx[4] + "px");
    			set_style(div, "width", /*nWidth*/ ctx[3] + "px");
    			add_location(div, file$5, 21, 0, 432);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console_1$3.warn("<GreyNodeBoundary> was created without expected prop 'key'");
    		}

    		if (node === undefined && !('node' in $$props || $$self.$$.bound[$$self.$$.props['node']])) {
    			console_1$3.warn("<GreyNodeBoundary> was created without expected prop 'node'");
    		}

    		if (heightRatio === undefined && !('heightRatio' in $$props || $$self.$$.bound[$$self.$$.props['heightRatio']])) {
    			console_1$3.warn("<GreyNodeBoundary> was created without expected prop 'heightRatio'");
    		}

    		if (widthRatio === undefined && !('widthRatio' in $$props || $$self.$$.bound[$$self.$$.props['widthRatio']])) {
    			console_1$3.warn("<GreyNodeBoundary> was created without expected prop 'widthRatio'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$3.warn(`<GreyNodeBoundary> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*node, heightRatio, widthRatio, top*/ 226) {
    			{
    				$$invalidate(4, nHeight = Math.max(node.height * heightRatio, 5));
    				$$invalidate(3, nWidth = Math.max(node.width * widthRatio, 5));
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const greynode_changes = {};
    			if (dirty & /*$nodesStore*/ 32) greynode_changes.node = /*node*/ ctx[11];
    			if (dirty & /*key*/ 1) greynode_changes.key = /*key*/ ctx[0];
    			if (dirty & /*heightRatio*/ 8) greynode_changes.heightRatio = /*heightRatio*/ ctx[3];
    			if (dirty & /*widthRatio*/ 16) greynode_changes.widthRatio = /*widthRatio*/ ctx[4];
    			greynode.$set(greynode_changes);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:8) {#each $nodesStore as node}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(`miniMap miniMap-${/*key*/ ctx[0]}`) + " svelte-enqdqj"));
    			set_style(div, "height", /*mapHeight*/ ctx[1] + 20 + "px");
    			set_style(div, "width", /*mapWidth*/ ctx[2] + 20 + "px");
    			add_location(div, file$4, 34, 4, 948);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$nodesStore, key, heightRatio, widthRatio*/ 57) {
    			...
    			if (!current || dirty & /*key*/ 1 && div_class_value !== (div_class_value = "" + (null_to_empty(`miniMap miniMap-${/*key*/ ctx[0]}`) + " svelte-enqdqj"))) {
    				attr_dev(div, "class", div_class_value);
    			}

    			if (!current || dirty & /*mapHeight*/ 2) {
    				set_style(div, "height", /*mapHeight*/ ctx[1] + 20 + "px");
    			}

    			if (!current || dirty & /*mapWidth*/ 4) {
    				set_style(div, "width", /*mapWidth*/ ctx[2] + 20 + "px");
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('key' in $$props) $$invalidate(0, key = $$props.key);
    		if ('d3Translate' in $$props) $$invalidate(7, d3Translate = $$props.d3Translate);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$heightStore, $widthStore, mapWidth, mapHeight, heightRatio*/ 782) {
    			{
    				if ($heightStore > $widthStore) {
    					$$invalidate(1, mapHeight = 100);
    					$$invalidate(2, mapWidth = Math.max($widthStore.toFixed(0) * 100 / $heightStore.toFixed(0), 25));
    				} else if ($heightStore < $widthStore) {
    					$$invalidate(2, mapWidth = 100);
    					$$invalidate(1, mapHeight = Math.max($heightStore.toFixed(0) * 100 / $widthStore.toFixed(0), 25));
    				} else {
    					$$invalidate(1, mapHeight = 100);
    					$$invalidate(2, mapWidth = 100);
    				}

    				$$invalidate(4, widthRatio = mapWidth / $widthStore);
    				$$invalidate(3, heightRatio = mapHeight / $heightStore);
    ...
    class MinimapBoundary extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$4, create_fragment$4, safe_not_equal, { key: 0, d3Translate: 7 });
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$3, 186, 4, 6675);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$3, 175, 6, 6463);
    			...
    			add_location(pattern, file$3, 167, 4, 6304);
    			add_location(defs, file$3, 166, 2, 6293);
    			add_location(g, file$3, 190, 2, 6852);
    			...
    			add_location(svg, file$3, 165, 0, 6212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
