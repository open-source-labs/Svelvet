...
>>>>>>> testenv
  ...
  `);
    			...
    			add_location(div, file$a, 205, 0, 7440);
    		},
    		m: function mount(target, anchor) {
  ...
  `)) {
    ...
    `);
    			...
    			add_location(div, file$a, 170, 2, 6425);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (key === undefined && !('key' in $$props || $$self.$$.bound[$$self.$$.props['key']])) {
    			console_1$4.warn("<EdgeAnchor> was created without expected prop 'key'");
    		}

    		if (node === undefined && !('node' in $$props || $$self.$$.bound[$$self.$$.props['node']])) {
    			console_1$4.warn("<EdgeAnchor> was created without expected prop 'node'");
    		}

    		if (position === undefined && !('position' in $$props || $$self.$$.bound[$$self.$$.props['position']])) {
    			console_1$4.warn("<EdgeAnchor> was created without expected prop 'position'");
    		}

    		if (role === undefined && !('role' in $$props || $$self.$$.bound[$$self.$$.props['role']])) {
    			console_1$4.warn("<EdgeAnchor> was created without expected prop 'role'");
    		}

    		if (width === undefined && !('width' in $$props || $$self.$$.bound[$$self.$$.props['width']])) {
    			console_1$4.warn("<EdgeAnchor> was created without expected prop 'width'");
    		}

    		if (height === undefined && !('height' in $$props || $$self.$$.bound[$$self.$$.props['height']])) {
    			console_1$4.warn("<EdgeAnchor> was created without expected prop 'height'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$4.warn(`<EdgeAnchor> was created with unknown prop '${key}'`);
    	});
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 183, 4, 5804);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$7, 180, 6, 5686);
    			attr_dev(div, "contenteditable", "true");
    			add_location(div, file$7, 179, 4, 5651);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$7, 168, 6, 5318);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 120, 0, 4173);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
=======
    		source: "(176:0) {#if minimap && boundary}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    		source: "(189:6) {#if node.data.html}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    		source: "(184:4) {#each $nodesStore as node}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    			add_location(rect, file$3, 223, 4, 8110);
>>>>>>> testenv
    		},
    		m: function mount(target, anchor) {
...
=======
    		source: "(223:2) {#if $backgroundStore}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    		source: "(230:6) {#if edge.type === 'straight'}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    // (229:4) {#each $derivedEdges as edge}
>>>>>>> testenv
...
=======
    		source: "(229:4) {#each $derivedEdges as edge}",
>>>>>>> testenv
    		ctx
    	});
...
=======
    			add_location(circle, file$3, 212, 6, 7898);
>>>>>>> testenv
